...
$http_type = "https:";} else {$http_type = "http:";} 
 ?>
<link href='<?php echo $http_type;?>//fonts.googleapis.com/css?family=Arimo:400,700' rel='stylesheet' type='text/css'>
<link href='<?php echo $http_type;?>//fonts.googleapis.com/css?family=Droid+Sans:400,700' rel='stylesheet' type='text/css'> 
...
<header id="header-container">
 <div class="top_header">
	...
	<?php echo $currency; ?>
	<div class="links">												
		<a href="<?php echo $account; ?>" class="links_account"><?php echo $text_account; ?></a>
...
<div class="custom_footer_main1 column">
			<div class="custom_footer_inner1">
