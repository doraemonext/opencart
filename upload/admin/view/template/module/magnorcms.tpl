...
<div id="content">
	...
	<div class="box">
		...
		<?php foreach ($modules as $module) { ?>
			...
			<?php if ($module['position'] == 'content_block_footer') { ?>
			<option value="content_block_footer" selected="selected"><?php echo $text_content_block_footer; ?></option>
			<?php } else { ?>
			<option value="content_block_footer"><?php echo $text_content_block_footer; ?></option>
			<?php } ?>
			...
			<table id="layout_sort_<?php echo $module_row; ?>" class="form" style=" <?php if ($module['position'] == 'content_footer' || $module['position'] =='content_footer_block' || $module['position'] == 'content_block_footer') echo 'display:none'; else echo 'display:block';?>" cl > 
...
html += '        <option value="content_block_footer"><?php echo $text_content_block_footer; ?></option>';
html += '      </select></td>';
html += '    </tr>';
html += '    <tr>';
...
{
if(val=='content_footer' || val=='content_footer_block' ||  val=='content_block_footer') 
{
